classdef rocket_orbit_simulator_test_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.rocket.Position = [10 454 463 166];
            ...
            app.checking_kg_or_g.Position = [398 97 54 36];
            ...
            app.gLabel.Position = [254 103 64 22];
            ...
            app.constant_weight.Position = [336 101 60 25];
            ...
            app.Label_2.Position = [23 59 130 34];
            ...
            app.drag_coefficient.Position = [157 66 69 27];
            ...
            app.sEditFieldLabel_2.Position = [91 36 62 22];
            ...
            app.thrust_time.Position = [175 33 51 27];
            ...
            app.Label_11.Position = [226 35 96 22];
            ...
            app.fuel_weight_begin.Position = [342 35 53 25];
            ...
            app.NsecLabel.Position = [10 5 173 22];
            ...
            app.total_impulse.Position = [186 2 41 28];
            ...
            app.kgLabel.Position = [225 6 96 22];
            ...
            app.fuel_weight_end.Position = [343 4 53 28];
            ...
            app.orbit.Position = [18 3 389 281];
            ...
            app.h_t_graph.Position = [3 1 403 291];
            ...
            app.fundamental_details.Position = [318 128 230 313];
            ...
            app.Button_2.Position = [831 234 129 49];
